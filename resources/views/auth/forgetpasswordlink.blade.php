    ...
    <div class="col-md-4 col-10 box-shadow-2 p-0">
      <div class="card border-grey border-lighten-3 m-0">
        <div class="card-header border-0">
          ...
          <h6 class="card-subtitle line-on-side text-muted text-center font-small-3 pt-2">
            <span>أكتب كلمة المرور الجديدة</span>
          </h6>
        </div>
      ...
      <form class="form-horizontal form-simple"  novalidate method="POST" action="{{route('reset-user-password.post')}}">
        ...
        <fieldset class="form-group position-relative has-icon-left mb-0">
          <input type="password" name="password" class="form-control form-control-lg input-lg @error('password') is-invalid @enderror"
        ...
        <br>
        <button type="submit" class="btn btn-info btn-lg btn-block"><i class="ft-unlock"></i> حفظ </button>
      </form>
    </div>
  </div>
