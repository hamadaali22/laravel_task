            ...
            <div class="col-xl-5 col-md-8">
                 @if(session()->has('message'))
                    ...
                    @if(Session::has('errorss'))
                     ...
                     @endif
                <form class="bg-white rounded shadow-5-strong p-5" method="POST" action="{{route('user-profile-update')}}" enctype="multipart/form-data">
                ...
                <!-- Email input -->
                 <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <!-- <i class="fas fa-lock icon" ></i> -->
                            <input type="notes" name="notes" value="{{ Auth::user()->notes }}" class="form-control" placeholder="notes" >
                        </div>
                        <br>
                        <div class="form-group">
                            @if(Auth::user()->image)
                            <img src="{{asset('img/profiles/'.Auth::user()->image) }}" width="100px">
                            @endif
                        </div>    
                        <div class="form-group">
                            <!-- <i class="fas fa-lock icon" ></i> -->
